    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-muted">
          Download the populated Word agreement first. After Canaan Preserve Accepts, this demo
          can send it through DocuSign, or you can upload a signed copy. Production DocuSign is
          confirmed at go-live. The Canaan Ranch LLP witness is already routed from brand
          config. Nothing is executed until the team accepts and a signed artifact is on file.
        </p>
      </div>
          ...
          <label className={`choice-card ${method === "docusign" ? "choice-card-active" : ""}`}>
            ...
            <span>
              <span className="block font-medium text-ink">
                DocuSign after Accept (available on this demo)
              </span>
