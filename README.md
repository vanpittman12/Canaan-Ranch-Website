...
| Variable | Default |
| --- | --- |
| `CANAAN_WITNESS_NAME` | `Seller Witness` |
...
| `seller_witness` | Brand/env: Seller Witness / `vpittman@bourne-partners.com` (not on the public form) | Routing order 4 |
...
Optional (defaults are Seller Witness / `vpittman@bourne-partners.com`):
